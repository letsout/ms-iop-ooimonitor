...
//        logger.info("登陆成功！！！");
     ...
     * @return
     */
    public static boolean downloadCheckFileFTP(String remotePath, String localPath) throws RuntimeException, IOException {

        logger.info("remotePath:{};localPath{};interfaceId{}", remotePath, localPath);
